# Passed Models (2459 total)

These models passed the first two filters (no `deprecation_date`, and no release date older than 6 months in the name).
...
## FIREWORKS_AI-EMBEDDING-MODELS (7 models)
...
## PARALLEL_AI (2 models)
- `parallel_ai/search`
- `parallel_ai/search-pro`

## PERPLEXITY (41 models)
...
## VERTEX_AI-AI21_MODELS (5 models)
- `vertex_ai/jamba-1.5`
...
## VERTEX_AI-ANTHROPIC_MODELS (17 models)
...
## VERTEX_AI-IMAGE-MODELS (7 models)
...
## VERTEX_AI-LANGUAGE-MODELS (25 models)
...
## VERTEX_AI-LLAMA_MODELS (11 models)
...
## VERTEX_AI-MINIMAX_MODELS (1 models)
- `vertex_ai/minimaxai/minimax-m2-maas`

## VERTEX_AI-MISTRAL_MODELS (19 models)
...
## VERTEX_AI-MOONSHOT_MODELS (1 models)
- `vertex_ai/moonshotai/kimi-k2-thinking-maas`

## VERTEX_AI-OPENAI_MODELS (2 models)
- `vertex_ai/openai/gpt-oss-120b-maas`
- `vertex_ai/openai/gpt-oss-20b-maas`

## VERTEX_AI-QWEN_MODELS (4 models)
...
## VERTEX_AI-TEXT-MODELS (2 models)
- `text-unicorn`
- `text-unicorn@001`

## VERTEX_AI-VIDEO-MODELS (7 models)
